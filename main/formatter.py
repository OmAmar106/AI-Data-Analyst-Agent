                ...
                "messages": [
                    {
                        ...
                        "content": (
                            ...
                            "For any base64 answers, replace them with 'base64' (in string format), just make sure that the remaining answer are in correct format and overall format is correct as required by the problem."
                        )
